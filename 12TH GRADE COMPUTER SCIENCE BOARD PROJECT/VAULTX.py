...
db = mysq.connect(host = 'localhost', user = 'root', password = "YOURPASSWORDHERE")
    ...
    def reroute(e: RouteChangeEvent):
        ...
        if page.route == '/registration':
            ...
            def load_data():
                ...
                #DATACELLS ARE LIKE SINGULAR EXCEL CELLS
            ...
            def entry_to_sql(e):
                ...
                if " " in title_entry:
                    page.dialog = dlg = flet.AlertDialog(title=flet.Text("Title Cannot Contain Spaces"))
                    dlg.open = True
                    page.update()

                elif title_entry not in fetch_data:
            ...
            def edit_to_sql(e):
                ...
                elif title_toedit in title_data:
